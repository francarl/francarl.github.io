...
ENABLE_MTP="false"
MODEL_DIR="unsloth/Qwen3.8-27B-GGUF"
CACHE_TYPE="q4_0"
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    --ctx-size)
      ...
      ;;
    --help)
      echo "Usage: --version <V> (default Q8_K_XL) --enable-mtp <true|false> (default false) --cache-type <T> (default q8_0) --ctx-size <N> (default 131072)"
      exit 1
      ;;
    *)
...
MODEL="Qwen3.8-27B-UD-${VERSION}.gguf"
